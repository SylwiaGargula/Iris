...
public class Adaline {
    ...
    public void startlearnig() throws FileNotFoundException {
        PrintWriter zapis = new PrintWriter("Adaline_czas.txt");
        PrintWriter zapis1 = new PrintWriter("Adaline_bledy_wal.txt");
        PrintWriter zapis2 = new PrintWriter("Adaline_MSE_wal.txt");
        PrintWriter zapis12 = new PrintWriter("Adaline_bledy.txt");
        PrintWriter zapis22 = new PrintWriter("Adaline_MSE.txt");
        PrintWriter zapis3 = new PrintWriter("Adaline logi.txt");
        ZbierzDane();
    ...
    double wynikf=f(sumuj); //sprawdzanie z wynikiem w pliku
        ...
        if(wynikf!=f(wartosciNowe[4]))
        {
            for(int i=0; i<4; i++)
                //regula delta
        wagi[i]=wagi[i]+(wartosciNowe[4]-wynikf)*0.1*wartosciNowe[i];
