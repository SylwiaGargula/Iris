 ...
 */
public class HebbaBezNauczyciela {
    ...
    public void startlearnig() throws FileNotFoundException {
        PrintWriter zapis = new PrintWriter("HebbaBezNauczyciela.txt");
        PrintWriter zapis1 = new PrintWriter("Hebba bez nauczyciela_bledy.txt");
        PrintWriter zapis2 = new PrintWriter("Hebba bez nauczyciela_MSE.txt");
        PrintWriter zapis12 = new PrintWriter("Hebba bez nauczyciela_bledy_wal.txt");
        PrintWriter zapis22 = new PrintWriter("Hebba bez nauczyciela_MSE_wal.txt");
        PrintWriter zapis3 = new PrintWriter("logi Hebba bez nauczyciela .txt");
        ZbierzDane();
        losujWagi();
    ...
    double wynikf=f(sumuj); //sprawdzanie z wynikiem w pliku
        ...
        for(int i=0;i<4;i++)
        {
            ...
            wagi[i]+=0.001*wartosciNowe[i]*wynikf;
        }
