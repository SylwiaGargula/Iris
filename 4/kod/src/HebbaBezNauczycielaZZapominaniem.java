 ...
 */
public class HebbaBezNauczycielaZZapominaniem {
    ...
    public void startlearnig() throws FileNotFoundException {
        PrintWriter zapis = new PrintWriter("HebbaBezNauczycielaZzapominaniem.txt");
        PrintWriter zapis1 = new PrintWriter("Hebba bez nauczycielaZzapominaniem_bledy.txt");
        PrintWriter zapis2 = new PrintWriter("Hebba bez nauczycielaZzapominaniem_MSE.txt");
        PrintWriter zapis12 = new PrintWriter("Hebba bez nauczycielaZzapominaniem_bledy_wal.txt");
        PrintWriter zapis22 = new PrintWriter("Hebba bez nauczycielaZzapominaniem_MSE_wal.txt");
        PrintWriter zapis3 = new PrintWriter("logi Hebba bez nauczycielaZzapominaniem .txt");
        ZbierzDane();
        losujWagi();
    ...
    double wynikf=f(sumuj); //sprawdzanie z wynikiem w pliku
        ...
        for(int i=0;i<4;i++)
        {
            ...
            wagi[i]=(1-0.1)*wagi[i]+0.001*wartosciNowe[i]*wynikf;
        }
