 ...
 */
public class HebbaZNauczycielemZZapominaniem {
    ...
    public void startlearnig() throws FileNotFoundException {
        PrintWriter zapis1=new PrintWriter("HebbaZNauczycielaZZapominaniem.txt");
...
zapis1.close();
    ...
    double wynikf=f(sumuj); //sprawdzanie z wynikiem w pliku
        ...
        if(wynikf!=wartosciNowe[4]) {
            for (int i = 0; i < 4; i++) {
                wagi[i] =(1-0.1)*wagi[i] + 0.001*wartosciNowe[i] *wartosciNowe[4];
